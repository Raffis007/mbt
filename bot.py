...
Escolha sua opção:
    ...
    bot.send_message(call.message.chat.id, texto_opcoes, parse_mode='Markdown', reply_markup=markup)
...
🔙 Volte ao menu para escolher seu pacote + VIP
    ...
    bot.send_message(call.message.chat.id, texto_info, parse_mode='Markdown', reply_markup=markup)
    bot.answer_callback_query(call.id)
